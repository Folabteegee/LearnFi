...
// Animation variants (same as pricing page)
const fadeIn = {
  hidden: { opacity: 0 },
...
export default function AboutUs() {
  ...
  return (
    <div className="overflow-x-hidden">
      {/* Background graphics - same as pricing page */}
      <div
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                {
                  title: "Accessibility",
                  description: "We break down complex Web3 concepts into approachable learning experiences for everyone.",
                  icon: "🔓"
                },
                {
                  title: "Innovation",
                  description: "We stay at the forefront of Web3 developments to provide the most relevant education.",
                  icon: "💡"
                },
                {
                  title: "Community",
                  description: "We believe learning happens best together, supported by peers and mentors.",
                  icon: "👥"
                }
              ].map((value, index) => (
                <motion.div 
      ...
      {/* Footer Section - Same as pricing page */}
