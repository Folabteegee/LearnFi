  ...
  return (
    <div className="relative min-h-screen overflow-hidden flex flex-col">
      <div className="relative w-screen min-h-screen bg-[url('/images/gradient.png')] bg-cover bg-center">
        ...
        <main ref={heroRef} className="text-white z-10 my-8 md:my-20 mx-4 md:mx-10 lg:mx-20 xl:mx-40 flex flex-col items-center">
          ...
          >
            <motion.h1 
              variants={slideUp}
              className="font-bold text-4xl md:text-5xl lg:text-6xl xl:text-7xl mb-4"
            >
            ...
            <motion.h2 
              ...
              className="font-normal text-3xl md:text-4xl lg:text-5xl xl:text-6xl"
            >
              Build the Future.
            </motion.h2>
          </motion.div>
          ...
          <div className="w-full max-w-6xl flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 lg:gap-20 px-4">
            ...
            <motion.div 
              ...
              className="w-32 h-24 md:w-40 md:h-30 lg:w-48 lg:h-36 xl:w-56 xl:h-42 flex justify-center"
            >
              <Image
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="border font-thin text-sm border-white rounded-lg px-8 py-3 md:px-12 md:py-3 bg-[#313131] hover:bg-black transition-colors duration-200 whitespace-nowrap -mt-30"
            >
              Register now
            </motion.button>
        ...
        >
          <div>
            <motion.h2 
              variants={slideUp}
              className="font-light text-xl sm:text-2xl md:text-3xl mx-auto max-w-4xl leading-relaxed"
            >
          ...
          <motion.div 
            ...
            className="flex flex-col md:flex-row flex-wrap mt-15 mx-auto items-center justify-center gap-8"
          >
             <div className="flex flex-row gap-10">
            {/* Card 1 */}
            <motion.div variants={cardItem} className="w-[270px]">
              <Atropos>
                <motion.div 
                ...
                >
                  ...
                  />
                  <h1 className="pt-6">Blockchain <br/>Fundamentals</h1>
                  <div className="pt-6 mt-auto">
                    <motion.button 
                      whileHover={{ scale: 1.05, backgroundColor: "rgba(74, 42, 122, 0.8)" }}
                      whileTap={{ scale: 0.95 }}
                      className="border-1 font-light border-white rounded-lg px-4 py-2 md:px-5 md:py-2 text-xs md:text-sm bg-[#FC4040]/10 hover:bg-[#4a2a7a] transition-colors duration-200 whitespace-nowrap"
                    >
                      Explore More
                    </motion.button>
                  </div>
              ...
              <Atropos>
                ...
                >
                  <Image
                    ...
                    className="flex items-center justify-center"
                  />
                  <h1 className="pt-6">Wallets&<br/> Web3 Identity</h1>
                  <div className="pt-6 mt-auto">
                    <motion.button 
                      whileHover={{ scale: 1.05, backgroundColor: "black" }}
                      whileTap={{ scale: 0.95 }}
                      className="border-1 font-light border-white rounded-lg px-4 py-2 md:px-5 md:py-2 text-xs md:text-sm bg-[#313131] hover:bg-black transition-colors duration-200 whitespace-nowrap"
                    >
                      Explore More
                    </motion.button>
                  </div>
              ...
              <Atropos>
                ...
                >
                  <Image
                    ...
                    className="flex items-center justify-center"
                  />
                  <h1 className="pt-6">Smart Contracts <br/> 101</h1>
                  <div className="pt-6 mt-auto">
                    <motion.button 
                      whileHover={{ scale: 1.05, backgroundColor: "rgba(74, 42, 122, 0.8)" }}
                      whileTap={{ scale: 0.95 }}
              ...
              <Atropos>
                ...
                >
                  <Image
                    ...
                    className="flex items-center justify-center"
                  />
                  <h1 className="pt-6">NFTs & the Creator <br/>Economy</h1>
                  <div className="pt-6 mt-auto">
                    <motion.button 
                      whileHover={{ scale: 1.05, backgroundColor: "rgba(74, 42, 122, 0.8)" }}
                      whileTap={{ scale: 0.95 }}
              ...
              <Atropos>
                ...
                >
                  <Image
                    ...
                    className="flex items-center justify-center"
                  />
                  <h1 className="pt-6">DAOs & Decentralized<br/> Governance</h1>
                  <div className="pt-6 mt-auto">
                    <motion.button 
                      whileHover={{ scale: 1.05, backgroundColor: "black" }}
                      whileTap={{ scale: 0.95 }}
              ...
              <Atropos>
                ...
                >
                  <Image
                    ...
                    className="flex items-center justify-center"
                  />
                  <h1 className="py-6">Build Your First DApps</h1>
                  <div className="pt-6 mt-auto">
                    <motion.button 
                      whileHover={{ scale: 1.05, backgroundColor: "rgba(74, 42, 122, 0.8)" }}
                      whileTap={{ scale: 0.95 }}
                      className="border-1 border-white font-light rounded-lg px-4 py-2 md:px-5 md:py-2 text-xs md:text-sm bg-[#FC4040]/10 hover:bg-[#4a2a7a] transition-colors duration-200 whitespace-nowrap"
                    >
                      Explore More
                    </motion.button>
                  </div>
        ...
        <motion.div 
          ...
          className="z-10 mt-15 text-white text-center px-4 sm:px-6 md:px-8 lg:px-10 py-8"
        >
          <motion.div 
            variants={slideUp}
          ...
          <motion.div 
            variants={slideUp}
            transition={{ delay: 0.3 }}
            className="pt-10 text-2xl font-light"
          >
      ...
      <motion.div
        ...
        variants={fadeIn}
        ref={testimonialRef}
        className="relative w-screen min-h-screen bg-[url('/images/img.png')] bg-cover bg-center flex flex-col items-center justify-center py-30"
      >
        {/* Blurry Container */}
        <motion.div 
          variants={staggerContainer}
          className="relative z-10 -mt-25 bg-white/10 backdrop-blur-md border border-white/10 rounded-xl p-6 flex gap-6 flex-wrap justify-center"
        >
          {/* Image 1 */}
          <motion.div 
            variants={cardItem}
        ...
        <motion.div 
          variants={slideUp}
          className="text-white text-4xl mt-25 font-semibold"
        >
      ...
      <motion.div 
        ...
        animate={testimonialInView ? "visible" : ""}
        variants={staggerContainer}
        className="flex flex-col gap-5 z-10 -mt-40 w-full  py-16"
      >
        {/* testimonies row 1 */}
        <div className="text-white flex flex-wrap px-10 justify-center gap-5">
          {/* Card 1 */}
          <motion.div variants={cardItem} className="w-[360px]">
            <Atropos>
              <motion.div 
                whileHover={{ y: -5 }}
                className="border border-gray-500 px-6 py-8 bg-gradient-to-r from-[#2C2A7B]/20 to-[#FFFFFF]/10 rounded-lg h-[320px] flex flex-col justify-between overflow-hidden"
              >
                ...
                <div className="flex flex-row pt-6 items-center gap-6">
                  <motion.div 
                    ...
                    className="w-10 h-10 flex items-center justify-center rounded-full bg-blue-700 text-sm font-bold"
                  >
                    I
                  </motion.div>
          ...
          <motion.div variants={cardItem} className="w-[360px]">
            <Atropos>
              <motion.div 
                whileHover={{ y: -5 }}
                className="border border-gray-500 px-6 bg-gradient-to-r from-[#2C2A7B]/20 to-[#FFFFFF]/10 py-8 rounded-lg h-[320px] flex flex-col justify-between overflow-hidden"
              >
                <h3 className="text-sm leading-relaxed">
          ...
          <motion.div variants={cardItem} className="w-[360px]">
            <Atropos>
              <motion.div 
                whileHover={{ y: -5 }}
                className="border border-gray-500 bg-gradient-to-r from-[#2C2A7B]/20 to-[#FFFFFF]/10 px-6 py-8 rounded-lg h-[320px] flex flex-col justify-between overflow-hidden"
              >
                <h3 className="text-sm leading-relaxed">
      ...
      <motion.div 
        ...
        variants={fadeIn}
        className="relative z-10 -mt-15 pt-40 bg-[#171717]"
      >
        <div className="text-white">
          <div className="relative w-screen min-h-[33vh] flex flex-col items-center justify-center py-30 mx-auto max-w-full">
            ...
            <motion.h1 
              variants={slideUp}
              className="relative z-10 text-white text-6xl font-medium"
            >
            ...
            <motion.p 
              variants={slideUp}
              transition={{ delay: 0.2 }}
              className="relative z-10 text-white font-extralight pt-2 text-3xl mt-4"
            >
            ...
            <div className="pt-5">
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="relative z-10 mt-6 bg-[#5940FC]/80 border-white border-1 text-white px-10 py-4 rounded-xl font-semibold"
              >
                Start Learning
              </motion.button>
            </div>
      ...
      <motion.div 
        ...
        className="bg-[#171717] z-10 text-white pt-50 pb-20 -mt-5 px-4 sm:px-6 lg:px-8"
      >
        <div className="max-w-7xl mx-auto w-full">
          ...
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            transition={{ delay: 1 }}
            className="pt-8 text-gray-400 pl-10 text-sm"
          >
